...
export class InitSchema1750581749485 implements MigrationInterface {
    name = 'InitSchema1750581749485'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "discount_type" ("discount_type_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type_name" character varying(50), "description" text, "is_active" boolean DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fd4cd02c7eceb2f13486f0240b3" PRIMARY KEY ("discount_type_id"))`);
        await queryRunner.query(`CREATE TABLE "promotion" ("promotion_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "promotion_name" character varying(100), "description" text, "discount_value" numeric(10,2), "start_date" TIMESTAMP, "end_date" TIMESTAMP, "is_active" boolean DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "distributor_id" uuid, "discount_type_id" uuid, CONSTRAINT "PK_1227013bca6804cf7c972526721" PRIMARY KEY ("promotion_id"))`);
