...
export class UpdateBatchProduct1753084421691 implements MigrationInterface {
    name = 'UpdateBatchProduct1753084421691'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "batch_product" ("batch_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "batch_number" character varying(50) NOT NULL, "quantity" integer, "manufactured_date" date, "expiry_date" date, "low_stock_threshold" integer DEFAULT '10', "unit_product_price" double precision NOT NULL DEFAULT '0', "is_active" boolean DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "is_deleted" boolean NOT NULL DEFAULT false, "product_id" uuid, "invenstory_id" uuid, "productTypesProductTypeId" uuid, CONSTRAINT "PK_9783ad350db6a237292093bad9e" PRIMARY KEY ("batch_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "batch_product" ADD CONSTRAINT "FK_0e5bcbe59947c6f0d77cf99a2ad" FOREIGN KEY ("productTypesProductTypeId") REFERENCES "product_type"("product_type_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_consultation" ADD CONSTRAINT "FK_86345eba71d212aaf2327194469" FOREIGN KEY ("disease_id") REFERENCES "disease"("disease_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ai_consultation" DROP CONSTRAINT "FK_86345eba71d212aaf2327194469"`);
        ...
        await queryRunner.query(`ALTER TABLE "batch_product" DROP CONSTRAINT "FK_0e5bcbe59947c6f0d77cf99a2ad"`);
