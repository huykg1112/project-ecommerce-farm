...
export class InitDatabase1752577245027 implements MigrationInterface {
    name = 'InitDatabase1752577245027'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invenstory" ("invenstory_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255), "business_license" character varying(255), "invenstory_address" character varying(255), "invenstory_lat" numeric(9,6), "invenstory_lng" numeric(9,6), "invenstory_img" character varying(255), "is_active" boolean DEFAULT true, "is_deleted" boolean DEFAULT false, "distributor_id" uuid, CONSTRAINT "REL_fb0d44f6817f37d34e0961000d" UNIQUE ("distributor_id"), CONSTRAINT "PK_831255ec4ef71ed06adbe15fa43" PRIMARY KEY ("invenstory_id"))`);
