...
export const DashboardCharts = memo<DashboardChartsProps>(({ revenueData, userDistribution, timeRange }) => {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card className="card-agricultural">
        <CardHeader>
          <CardTitle className="text-agricultural-primary font-bold flex items-center gap-2">📈 {chartTitle}</CardTitle>
      ...
      <Card className="card-agricultural">
        <CardHeader>
          ...
          <p className="text-sm text-agricultural-secondary">Tỷ lệ phân bố giữa nông dân và nhà phân phối</p>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              ...
              <Tooltip formatter={(value: number) => [`${value}%`, "Tỷ lệ"]} contentStyle={tooltipStyle} />
            </PieChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
