...
import { useProducts, useProductStore } from "@/hooks/use-products"

export function ProductPagination() {
  const { currentPage, totalPages, totalItems, itemsPerPage, setFilters, fetchProducts } = useProducts()
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center space-x-2">
        <p className="text-sm text-muted-foreground">
          ...
          {Math.min(currentPage * itemsPerPage, totalItems)} trong tổng số {totalItems} sản phẩm
        </p>
      </div>
