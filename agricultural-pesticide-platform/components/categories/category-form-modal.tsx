...
import type { CategoryFormData } from "@/lib/store/category-store"
...
export const CategoryFormModal = memo<CategoryFormModalProps>(
  ({ open, onClose, onSubmit, formData, onUpdateFormData, title, submitText, isEdit = false }) => {
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(formData.category_img || null)
            ...
            <div className="space-y-2">
              ...
              {imagePreview ? (
                ...
                >
                  ...
                  <p className="text-[#74a65d] text-sm text-center">Nhấp để tải lên hình ảnh danh mục</p>
