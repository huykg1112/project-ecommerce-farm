...
import type { UserStatisticsFilters, TimeRange, UserRole, UserStatus } from "@/lib/store/user-statistics-store"
...
export const StatisticsFilters = memo<StatisticsFiltersProps>(({ filters, onFiltersChange, onReset }) => {
