...
export const UserDataTable = memo<UserDataTableProps>(({ users, loading = false }) => {
  ...
  const getStatusBadge = (isActive: boolean) => {
    return isActive
      ? { label: "Hoạt động", variant: "default" as const, className: "bg-[#90c577] hover:bg-[#74a65d]" }
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-[#accc8b]/20 hover:bg-[#accc8b]/30">
              ...
              <TableHead className="text-[#44703d] font-semibold">Số điện thoại</TableHead>
              <TableHead className="text-[#44703d] font-semibold">Email</TableHead>
                ...
                <TableCell>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-[#74a65d]">@{user.username}</div>
                    </div>
                  </div>
                </TableCell>
                <TableCell className="text-[#44703d]">{user.phone_number}</TableCell>
