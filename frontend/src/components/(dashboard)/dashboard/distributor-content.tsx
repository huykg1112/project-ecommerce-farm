...
import { mockBatchProducts } from "@/lib_dashboard/mock/batch-products";
...
export const DistributorContent = memo<DistributorContentProps>(
  ({ dashboardData }) => {
    ...
    const { lowStockBatches, expiringBatches } = useMemo(() => {
      const lowStock = mockBatchProducts.filter(
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="card-agricultural">
            <CardHeader>
              <CardTitle className="text-agricultural-primary">
                Tồn kho theo lô hàng
              </CardTitle>
              <p className="text-sm text-agricultural-secondary">
                Mức tồn kho hiện tại theo từng lô
              </p>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {mockBatchProducts.map((batch) => (
                  ...
                  >
                    <div>
                      <h4 className="font-semibold text-agricultural-primary">
                    ...
                    <div className="text-right">
                      <Badge
                        variant={
                          batch.quantity <= batch.low_stock_threshold
                            ? "destructive"
                            : "secondary"
                        }
                      >
