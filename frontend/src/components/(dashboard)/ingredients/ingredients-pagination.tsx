...
import { activeIngredientsFiltersAtom } from "@/lib_dashboard/store/active-ingredient-store";
...
export const IngredientsPagination = memo<IngredientsPaginationProps>(
  ({
    currentPage,
    totalPages,
    totalItems,
...
IngredientsPagination.displayName = "IngredientsPagination";
