...
import type { WarehouseFormData } from "@/lib_dashboard/store/warehouse-store";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleInputChange("invenstory_address", e.target.value)
                }
              ...
              {imagePreview ? (
                ...
                >
                  ...
                  <p className="text-[#74a65d] text-sm text-center">
                    Nhấp để tải lên hình ảnh kho hàng
                  </p>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("is_locked", !checked)
                  }
                  disabled={loading}
