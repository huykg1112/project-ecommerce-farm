              ...
              >
                ...
                <TableCell>
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-[#74a65d]">
                      <span className="font-medium">GPKD:</span>{" "}
                      {warehouse.business_license}
                    </div>
                    <div className="text-xs text-[#90c577]">
                      Tạo: {formatDate(warehouse.created_at)}
                    </div>
                  </div>
                </TableCell>
                <TableCell>
                  <div className="space-y-1">
                    <div className="font-semibold text-[#44703d]">
                      {warehouse.distributor.full_name}
                    </div>
                ...
                <TableCell>
                  <div className="flex items-start gap-1 text-sm text-[#74a65d] max-w-xs">
                    ...
                    <span className="line-clamp-3">
                      {warehouse.invenstory_address}
                    </span>
                  </div>
                  {warehouse.invenstory_lat && warehouse.invenstory_lng && (
                    <div className="text-xs text-[#90c577] mt-1">
                      📍 {warehouse.invenstory_lat.toFixed(4)},{" "}
                      {warehouse.invenstory_lng.toFixed(4)}
                    </div>
                  )}
                </TableCell>
                <TableCell>
                  <Badge
                    variant={
                      getStatusBadge(warehouse.is_locked || false).variant
                    }
                    className={
                      getStatusBadge(warehouse.is_locked || false).className
                    }
                  >
                ...
                <TableCell>
                  <Switch
                    ...
                    onCheckedChange={() =>
                      onToggleLock(warehouse.invenstory_id)
                    }
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    >
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          onDeleteWarehouse(warehouse.invenstory_id)
                        }
