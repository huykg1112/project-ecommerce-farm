...
export function DashboardHeader() {
  return (
    <header className="flex h-16 items-center justify-between border-b border-[#74a65d]/20 bg-white px-6 shadow-sm">
      ...
      <div className="relative hidden w-96 md:block">
        ...
        <Input placeholder="Tìm kiếm..." className="border-[#74a65d]/30 pl-10 focus-visible:ring-[#90c577]" />
      </div>
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="relative h-10 w-10 rounded-full p-0">
              <Avatar className="h-10 w-10 border-2 border-[#74a65d]/30">
                ...
                <AvatarFallback className="bg-[#90c577] text-white">ND</AvatarFallback>
              </Avatar>
            </Button>
          </DropdownMenuTrigger>
