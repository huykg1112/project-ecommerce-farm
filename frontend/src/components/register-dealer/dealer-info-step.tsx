...
export default function DealerInfoStep({
  data,
  updateData,
}: DealerInfoStepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600">
        Vui lòng cung cấp thông tin về đại lý của bạn. Thông tin này sẽ được
        hiển thị công khai trên trang web của chúng tôi.
      </p>
      ...
      <div className="space-y-2">
        ...
        />
        {errors.dealerName && (
          <p className="text-red-500 text-sm">{errors.dealerName}</p>
        )}
      </div>
      ...
      <div className="bg-green-50 p-4 rounded-lg border border-green-200">
        <p className="text-green-700 text-sm">
          <span className="font-medium">Mẹo:</span> Hình ảnh đại lý nên rõ ràng,
          chất lượng cao và thể hiện được không gian kinh doanh của bạn. Điều
          này sẽ giúp tăng độ tin cậy với khách hàng.
        </p>
      </div>
    </div>
  );
