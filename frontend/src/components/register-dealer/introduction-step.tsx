    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="font-medium">
            Quy trình đăng ký gồm 4 bước đơn giản và sẽ chỉ mất khoảng 5 phút để
            hoàn thành.
          </p>
        </div>
      </div>
      ...
      <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
        ...
        <p className="text-amber-700">
          Sau khi đăng ký, đội ngũ của chúng tôi sẽ xem xét thông tin và liên hệ
          với bạn trong vòng 2-3 ngày làm việc để xác nhận và hướng dẫn các bước
          tiếp theo.
        </p>
      </div>
    </div>
